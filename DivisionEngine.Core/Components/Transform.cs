...
namespace DivisionEngine.Components
{
    ...
    public class Transform : IComponent
    {
        ...
        public float3 Back => new float3(0, 0, 1).Transform(Matrix.CreateMatrix4x4FromQuaternion(rotation).ToMatrix4x4());
        public float3 Up => new float3(0, 1, 0).Transform(Matrix.CreateMatrix4x4FromQuaternion(rotation).ToMatrix4x4());
